...
namespace game_framework
{
	...
	private:
		...
		// vector<int> walls_amount = {25,25,29,23,26,23,27,26,23,27,26,23,27,26,27,21,27,23,24,26,30,27,27,23,24,};
		// vector<int> floors_amount = {17,17,19,14,17,15,17,16,13,21,18,13,17,19,17,12,17,15,16,17,21,17,17,13,17,};
		// vector<int> boxes_amount = {3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,2,};
		// vector<int> goals_amount = {3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,2,};
	};
